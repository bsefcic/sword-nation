  ...
  <Background color="bg-primary-500">
    <Section id="team" yPadding="py-36">
      <div className="grid grid-cols-1 gap-5 items-center">
        <TestimonialHeader subtitle="Lorem Ipsum" title="Echipa noastră">
        ...
        <div>
          ...
          >
            Mihai este cofondator și președinte al Asociației Sword Nation din
          ...
          >
            Fost sportiv de performanță în ramura sabie din scrima Românesca,
          ...
          >
            Cu un background în rugby-ul de performanță, Andrei și-a început
          ...
          >
            Vlad este un fizioterapeut tenace, fiind extrem de interesat de
